                ...
                <FullScreenOverlay className="">
                    <LeftContent className="text-[#212529] leading-none flex items-center  justify-center flex-col" >
                        ...
                        <div className="text-left flex items-center justify-center flex-col leading-[0.8] ">
                            ...
                            <motion.p variants={slideUp} initial="initial" animate="animate" className="text-[#212529] text-sm sm:text-center md:text-left w-[80%] md:w-[70%]"> Provide high-quality and visually appealing designs an animations, helping our clients bring  their creative visions to life in various industries including gaming, entertainment, and architecture</motion.p>
                        </div>
                    </LeftContent>
